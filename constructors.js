...
function Movie(name, genre, rating) {
  ...
  this.genre = genre;
  this.rating = rating;
  this.__proto__.changeRating = function(num) {
...
function User(name, age, email, savedPosts) {
  ...
  this.__proto__.addSavedPost = function(id, title, rating) {
  ...
  this.__proto__.removeSavedPost = function(number) {
    this.savedPosts.splice(number -1, 1)
  }
  this.__proto__.changePostRating = function(num1, num2) {
